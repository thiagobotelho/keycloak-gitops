...
- Prometheus Apps, OpenTelemetry Collector, Tempo e Pyroscope implantados pela
  stack GitOps;
- imagem `quay.io/thiagobotelho/rhbk-keycloak-custom:26.6.4-pyroscope-2.8.0-theme-1.2.5`
  publicada.
...
podman build \
  ...
  -t quay.io/thiagobotelho/rhbk-keycloak-custom:26.6.4-pyroscope-2.8.0-theme-1.2.5 \
  -f docker/Dockerfile .
```
